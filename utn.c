...
int getRandomTiempos()
{
    int aleatorio;

    aleatorio = rand()%(71)+50; //siempre se pone un numero mas grande del maximo que quiero.
    //siempre que se pide un valor con rand devuelve un valor distinto.
    return aleatorio;
}
